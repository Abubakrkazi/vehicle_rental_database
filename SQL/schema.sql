...
CREATE TABLE vehicles (
    ...
    vehicle_type VARCHAR(20) CHECK (vehicle_type IN ('Car', 'Bike', 'Truck')) NOT NULL,
    model VARCHAR(50),
    registration_number VARCHAR(50) UNIQUE NOT NULL,
    rental_price_per_day NUMERIC(10,2) NOT NULL,
    availability_status VARCHAR(20) CHECK (availability_status IN ('Available', 'Rented', 'Maintenance')) NOT NULL
);
